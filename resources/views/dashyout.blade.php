    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="categorie" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href=" {{ route('Filiere.create') }} ">Ajouter une Filière</a>
                        <a class="collapse-item" href=" {{ route('Filiere.index') }} ">Gérer les filières</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="stock" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href=" {{route('Etudiant.encours')}}  ">Liste des étudiants</a>
                        <a class="collapse-item" href="   {{ route('Etudiant.index') }} ">Gérer les étudiants</a>
                        <a class="collapse-item" href="   {{ route('Etudiant.refuse') }} ">Liste des étudiants refuse</a>
                        <a class="collapse-item" href="   {{ route('Etudiant.accepte') }} ">Liste des étudiants accepte</a>
                    </div>
                </div>
            </li>
             ...
             <li class="nav-item">
                ...
                <div id="utilisateur" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="  {{route('Professeur.encours')}} ">Liste des professeurs</a>
                    <a class="collapse-item" href=" {{ route('Professeur.index') }} ">Gérer les professeurs</a>
                    <a class="collapse-item" href="  {{route('Professeur.accepte')}} ">Liste des professeurs accepte</a>
                    <a class="collapse-item" href="  {{route('Professeur.refuse')}} ">Liste des professeurs refuse </a>
                    </div>
                </div>
            </li>
                        <form action=" {{route('logout')}} " method="POST">
                            @csrf
                            <button type="submit" class="btn btn-light ms-3">Se déconnecter</button>
                        </form>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{asset('dash/https://source.unsplash.')}}com/Mv9hjnEUHR4/60x60"
                                            alt="...">
                                        <div class="status-indicator bg-success"></div>
                                    </div>
                                    <div>
