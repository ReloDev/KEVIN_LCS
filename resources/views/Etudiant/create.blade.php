                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Formulaire d'enregistrement d'étudiants</h1>
                            </div>
                                        <form method ="POST" action="  {{route('Etudiant.store')}} " class="p-5 m-5" enctype="multipart/form-data">
                                          @csrf
                                          <div class="row">
                                          ...
                                          <div class="col-12">
                                                      <label for="yourUsername" class="form-label">Sélectionner la filiere </label>   <br>
                                                      <select name="id_filiere" id="" class="pt-2 pb-2 form-select form-select-sm">
                                                        @foreach ($filieres as $filiere )
                                                          <option class="col-12 " value="{{ $filiere->id }}"> {{$filiere->nomFIliere}} </option>
                                                        @endforeach
                                                      </select>
                                            </div>
                                          <div class="mb-3 col-6">
                                                <label for="exampleFormControlInput1" class="form-label">Entrer votre dernier diplôme</label>
                                                <div class="input-group mb-3">
                                                  <input type="file" class="form-control" id="inputGroupFile02" name="diplome">
                                          ...
                                          <div class="mb-3 col-6">
                                                ...
                                                <div class="input-group mb-3">
                                                  <input type="file" class="form-control" id="inputGroupFile02" name="toph">
                                                  <label class="input-group-text" for="inputGroupFile02">Upload</label>
                                                </div>
                                          </div>
                                          <br>
